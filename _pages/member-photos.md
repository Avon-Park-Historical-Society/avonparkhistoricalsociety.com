...
<head>
     ...
     <title>
      Memberphotos - Avonparkhistoricalsociety.com
     </title>
     ...
     <link rel="alternate" hreflang="en" href="https://avonparkhistoricalsociety.com" />
     <link rel="alternate" hreflang="x-default" href="https://avonparkhistoricalsociety.com" />
     ...
     <meta name="apple-mobile-web-app-title" content="Avonparkhistoricalsociety.com">
     <meta name="application-name" content="Avonparkhistoricalsociety.com">
     <meta name="msapplication-TileColor" content="#2b5797">
     <meta name="theme-color" content="#ffffff">

     <meta property="og:title" content="Memberphotos - Avon Park Historical Society" />
     <meta property="og:type" content="website" />
     <meta property="og:url" content="https://avonparkhistoricalsociety.com" />
...
<body>
   ...
   <div id="loginboxcontainer">
             <div class="loginwrap">
                ...
                <form action="?p=memberphotos" method="Post" name="loginform" class="loginform" id="loginform">
...
<div class="page-header">
    <h1>
        Community Photos<a href="?p=account_addmemberphoto" class="header-button">UPLOAD PHOTO</a>
    </h1>
</div>
<div style="margin-bottom:10px;">
 <ul class="breadcrumb">
  <li><a href="?"><i class="fas fa-home"></i> Home</a></li>
  <li class="active"><i class="fas fa-images"></i> Community Photos</li>
 </ul>
</div>
<div class="grid">
    ...
    <div class="collisting no-padding">
        <div class="search">
            <form class="flow" action="?p=memberphotos" method="post">
                <div class="fill">
                    <input type="text" name="searchtext" placeholder="Search Community Photos..." />
                </div>
                <div>
                    <select name="category">
                        <option value="all">All Categories</option>
                            ...
                            <option value="2" >1912 - 1929</option>
                        
                            <option value="3" >1930 - 1949</option>
                        
                            <option value="4" >1950 - 1969</option>
                        
                            <option value="5" >1970s</option>
                        
                            <option value="6" >1980s</option>
                        
                            <option value="8" >Museum Visitors</option>
                        
                            <option value="9" >Baseball Museum</option>
        ...
        <div style="margin: 10px 5px 5px 5px;">
            ...
            <div style="display:inline-block;padding:5px;box-sizing:border-box;">
                <a href="?p=memberphotos" style="font-size:14pt;font-weight:bold;">All</a>
            </div>
            
                <div style="display:inline-block;padding:5px;box-sizing:border-box;">
                    <a href="?p=memberphotos&cat=1" style="font-size:14pt;font-weight:bold;">General</a>
                </div>
            
                <div style="display:inline-block;padding:5px;box-sizing:border-box;">
                    <a href="?p=memberphotos&cat=2" style="font-size:14pt;font-weight:bold;">1912 - 1929</a>
                </div>
            
                <div style="display:inline-block;padding:5px;box-sizing:border-box;">
                    <a href="?p=memberphotos&cat=3" style="font-size:14pt;font-weight:bold;">1930 - 1949</a>
                </div>
            
                <div style="display:inline-block;padding:5px;box-sizing:border-box;">
                    <a href="?p=memberphotos&cat=4" style="font-size:14pt;font-weight:bold;">1950 - 1969</a>
                </div>
            
                <div style="display:inline-block;padding:5px;box-sizing:border-box;">
                    <a href="?p=memberphotos&cat=5" style="font-size:14pt;font-weight:bold;">1970s</a>
                </div>
            
                <div style="display:inline-block;padding:5px;box-sizing:border-box;">
                    <a href="?p=memberphotos&cat=6" style="font-size:14pt;font-weight:bold;">1980s</a>
                </div>
            
                <div style="display:inline-block;padding:5px;box-sizing:border-box;">
                    <a href="?p=memberphotos&cat=8" style="font-size:14pt;font-weight:bold;">Museum Visitors</a>
                </div>
            
                <div style="display:inline-block;padding:5px;box-sizing:border-box;">
                    <a href="?p=memberphotos&cat=9" style="font-size:14pt;font-weight:bold;">Baseball Museum</a>
                </div>
        ...
        <div>
               ...
               <div class="memberphotosimgcontainer">
                <img src="photos/members/267/communityphotos/thumbnail/thumb_100_0171.JPG" style="display:block;margin-left: 50%;transform: translateX(-50%);height:200px;cursor:pointer;"
                onclick="location='/memberphoto/168_Unity-of-Sebring'" alt="Unity of Sebring">
                
                
                <p style="text-align:center;font-size:8pt;color:#999999;padding:2px 5px 2px 2px;margin:0;">By: Avon Park Historical Society</p>
                <p style="text-align:center;font-size:10pt;font-weight:bold;max-width:200px;color:#000000;padding:2px 5px 2px 2px;margin:0 auto;">Unity of Sebring</p>
               
               </div>
               
               <div class="memberphotosimgcontainer">
                <img src="photos/members/267/communityphotos/thumbnail/thumb_100_0710.JPG" style="display:block;margin-left: 50%;transform: translateX(-50%);height:200px;cursor:pointer;"
                onclick="location='/memberphoto/167_Museum-Tour'" alt="Museum Tour">
                
                
                <p style="text-align:center;font-size:8pt;color:#999999;padding:2px 5px 2px 2px;margin:0;">By: Avon Park Historical Society</p>
                <p style="text-align:center;font-size:10pt;font-weight:bold;max-width:200px;color:#000000;padding:2px 5px 2px 2px;margin:0 auto;">Museum Tour</p>
               
               </div>
               
               <div class="memberphotosimgcontainer">
                <img src="photos/members/267/communityphotos/thumbnail/thumb_lg_Jim&Boys.JPG" style="display:block;margin-left: 50%;transform: translateX(-50%);height:200px;cursor:pointer;"
                onclick="location='/memberphoto/166_Dining-Car'" alt="Dining Car">
                
                
                <p style="text-align:center;font-size:8pt;color:#999999;padding:2px 5px 2px 2px;margin:0;">By: Avon Park Historical Society</p>
                <p style="text-align:center;font-size:10pt;font-weight:bold;max-width:200px;color:#000000;padding:2px 5px 2px 2px;margin:0 auto;">Dining Car</p>
               
               </div>
               
               <div class="memberphotosimgcontainer">
                <img src="photos/members/267/communityphotos/thumbnail/thumb_lg_IMG_0012.JPG" style="display:block;margin-left: 50%;transform: translateX(-50%);height:200px;cursor:pointer;"
               ...
               <div class="memberphotosimgcontainer">
                <img src="photos/members/267/communityphotos/thumbnail/thumb_100_0793.JPG" style="display:block;margin-left: 50%;transform: translateX(-50%);height:200px;cursor:pointer;"
                onclick="location='/memberphoto/164_Boys-and-Girls-Club'" alt="Boys and Girls Club">
                
                
                <p style="text-align:center;font-size:8pt;color:#999999;padding:2px 5px 2px 2px;margin:0;">By: Avon Park Historical Society</p>
                <p style="text-align:center;font-size:10pt;font-weight:bold;max-width:200px;color:#000000;padding:2px 5px 2px 2px;margin:0 auto;">Boys and Girls Club</p>
               
               </div>
               
               <div class="memberphotosimgcontainer">
                <img src="photos/members/267/communityphotos/thumbnail/thumb_100_0791.JPG" style="display:block;margin-left: 50%;transform: translateX(-50%);height:200px;cursor:pointer;"
                onclick="location='/memberphoto/163_Boys-and-Girls-Club'" alt="Boys and Girls Club">
               ...
               <div class="memberphotosimgcontainer">
                <img src="photos/members/267/communityphotos/thumbnail/thumb_100_0102.JPG" style="display:block;margin-left: 50%;transform: translateX(-50%);height:200px;cursor:pointer;"
                onclick="location='/memberphoto/162_Red-Hatters'" alt="Red Hatters">
                
                
                <p style="text-align:center;font-size:8pt;color:#999999;padding:2px 5px 2px 2px;margin:0;">By: Avon Park Historical Society</p>
                <p style="text-align:center;font-size:10pt;font-weight:bold;max-width:200px;color:#000000;padding:2px 5px 2px 2px;margin:0 auto;">Red Hatters</p>
               
               </div>
               
               <div class="memberphotosimgcontainer">
                <img src="photos/members/267/communityphotos/thumbnail/thumb_12-19.JPG" style="display:block;margin-left: 50%;transform: translateX(-50%);height:200px;cursor:pointer;"
                onclick="location='/memberphoto/161_Cornerstone-Academy'" alt="Cornerstone Academy">
                
                
                <p style="text-align:center;font-size:8pt;color:#999999;padding:2px 5px 2px 2px;margin:0;">By: Avon Park Historical Society</p>
                <p style="text-align:center;font-size:10pt;font-weight:bold;max-width:200px;color:#000000;padding:2px 5px 2px 2px;margin:0 auto;">Cornerstone Academy</p>
               
               </div>
               
               <div class="memberphotosimgcontainer">
                <img src="photos/members/267/communityphotos/thumbnail/thumb_Avon_Park_Train_gallery.jpg" style="display:block;margin-left: 50%;transform: translateX(-50%);height:200px;cursor:pointer;"
                onclick="location='/memberphoto/160_Avon-Park-Dining-Car'" alt="Avon Park Dining Car">
                
                
                <p style="text-align:center;font-size:8pt;color:#999999;padding:2px 5px 2px 2px;margin:0;">By: Avon Park Historical Society</p>
                <p style="text-align:center;font-size:10pt;font-weight:bold;max-width:200px;color:#000000;padding:2px 5px 2px 2px;margin:0 auto;">Avon Park Dining Car</p>
               
               </div>
               
               <div class="memberphotosimgcontainer">
                <img src="photos/members/267/communityphotos/thumbnail/thumb_100_0072.JPG" style="display:block;margin-left: 50%;transform: translateX(-50%);height:200px;cursor:pointer;"
                onclick="location='/memberphoto/159_Tanglewood-Friends'" alt="Tanglewood Friends">
                
                
                <p style="text-align:center;font-size:8pt;color:#999999;padding:2px 5px 2px 2px;margin:0;">By: Avon Park Historical Society</p>
                <p style="text-align:center;font-size:10pt;font-weight:bold;max-width:200px;color:#000000;padding:2px 5px 2px 2px;margin:0 auto;">Tanglewood Friends</p>
...
<div style="background-color:#3a2a45;color:#ffffff;height:100%;">
  <a href="?p=podcasts_listen&pid=141" style="color:#ffffff;"><img src="podcast/posters/CFC_Podcast_Sebring_Jimw.jpeg"></a>
  <p style="font-size:14pt;font-weight:bold;text-align:center;padding-top:10px;padding-bottom:2px;"><a href="?p=podcasts_listen&pid=141" style="color:#ffffff;">History with Jim Pollard</a></p>
  
  
   <div style="text-align:center;">
   <button class="playbutton" onclick="window.location.href='?p=podcasts_listen&pid=141';"><i class="fas fa-play"></i></button>
   </div>
   <p style="padding:5px;text-align:center;">In this episode the late Jim Pollard, past president of the Sebring Historical Society, discussed hi...</p>
...
<div id="memberphotopopup" style="display:none;position:fixed;top:0;left:0;z-index:1100;width:100%;height:100%;background:rgba(0,0,0,0.30);">
 ...
 <div class="" style="height:414px;">
    ...
    <div class="border fixed" style="">
     ...
     <div class="padding maincontentscrollingblock" style="clear:both;overflow-y:auto;overflow-x:hidden;" id="communityphotosblock69">

         <div class="slides">
           <button class="previous" data-role="none" onclick="GetNextMemberPhoto('164','communityphotosblock69','8','prev');" style="cursor:pointer;">&#xe902;</button>

                <img src="photos/members/267/communityphotos/thumbnail/thumb_100_0793.JPG"
                style="display:block;margin:0 auto;padding:5px 0;max-width:99%;max-height:275px;cursor:pointer;"
                onclick="location='/memberphoto/164_Boys-and-Girls-Club'" alt="Boys and Girls Club">


          <button class="next" data-role="none" onclick="GetNextMemberPhoto('164','communityphotosblock69','8','next');" style="cursor:pointer;">&#xe901;</button>
          <input type="hidden" name="pid" id="pid" value="164">
          <input type="hidden" name="cid" id="cid" value="communityphotosblock69">
         </div>

         <p style="text-align:center;font-size:8pt;color:#999999;padding:2px 5px 2px 2px;margin:0;">By: Avon Park Historical Society</p>
         <h3 style="text-align:center;">Boys and Girls Club</h3>
                   ...
                   <div style="margin-left: auto;">
                    ...
                    <div style="position:relative;">
                     <div style="display:inline-block;position:absolute;right:0;top:10px;">
                       ...
                       <div class="fb-like" data-href="https://avonparkhistoricalsociety.com/index.cfm?p=memberphotos" data-width="" data-layout="button" data-action="like" data-size="small" data-share="true"></div>
                       </div>
                      </div>
                     </div>
                   </div>
