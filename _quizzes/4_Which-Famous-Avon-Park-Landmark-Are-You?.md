---
title: "Which Famous Avon Park Landmark Are You? - Take The Quiz"
...
<head>
        ...
        <title>Which Famous Avon Park Landmark Are You? - Take The Quiz - Avon Park Historical Society</title>
        
        <base href="https://avonparkhistoricalsociety.com/" target="_parent">
        
        <meta name="viewport" content="width=device-width">
        <meta name="keywords" content="">
        <meta name="description" content="Which iconic&nbsp;Avon Park spot best matches your personality?">
        <link rel="alternate" hreflang="en" href="https://avonparkhistoricalsociety.com/index.cfm?p=quiz&v=4_Which-Famous-Avon-Park-Landmark-Are-You" />
        <link rel="alternate" hreflang="x-default" href="https://avonparkhistoricalsociety.com/index.cfm?p=quiz&v=4_Which-Famous-Avon-Park-Landmark-Are-You" />
        <META NAME="Subject" CONTENT="Which iconic&nbsp;Avon Park spot best matches your personality?">
        ...
        <link rel="canonical" href="https://avonparkhistoricalsociety.com/index.cfm?p=quiz&v=4_Which-Famous-Avon-Park-Landmark-Are-You" />
        ...
        <meta name="apple-mobile-web-app-title" content="https://avonparkhistoricalsociety.com/index.cfm?p=quiz&v=4_Which-Famous-Avon-Park-Landmark-Are-You">
        <meta name="application-name" content="Avonparkhistoricalsociety.com">
        <meta name="msapplication-TileColor" content="#2b5797">
        <meta name="theme-color" content="#ffffff">

        
        <meta property="og:title" content="Which Famous Avon Park Landmark Are You? - Take The Quiz - Avon Park Historical Society" />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://avonparkhistoricalsociety.com/index.cfm?p=quiz&v=4_Which-Famous-Avon-Park-Landmark-Are-You" />
        <meta property="og:site_name" content="Avonparkhistoricalsociety.com" />
        <meta property="og:description" content="Which iconic&nbsp;Avon Park spot best matches your personality?" />
        <meta property="og:image" content="https://avonparkhistoricalsociety.com/photos/quizes/which_one.jpg" />
        <meta property="og:image:secure_url" content="https://avonparkhistoricalsociety.com/photos/quizes/which_one.jpg" />
        <meta property="og:image:type" content="image/jpeg" />
        
        <meta property="og:image:alt" content="Which Famous Avon Park Landmark Are You?" />
...
<body>
   ...
   <div id="loginboxcontainer">
             <div class="loginwrap">
                ...
                <form action="?p=quiz&v=4_Which-Famous-Avon-Park-Landmark-Are-You" method="Post" name="loginform" class="loginform" id="loginform">
...
<div class="page-header">
    <h1>
        Quiz: <span style="font-weight:normal;font-size:14pt;">Which Famous Avon Park Landmark Are You?</span>
    </h1>
</div>
<div style="margin-bottom:10px;">
 <ul class="breadcrumb">
  ...
  <li class="active">Quiz - Which Famous Avon Park Landmark Are You?</li>
 </ul>
</div>
<div class="grid">
    ...
    <div class="col4">
       ...
       <div class="border" style="position:relative;overflow:visible;">
        ...
        <div style="padding:10px 0 0 15px;font-size:28pt;font-weight:bold;">
         Which Famous Avon Park Landmark Are You?
        </div>
        <div style="width:100%;text-align:center;"><img src="photos\quizes\which_one.jpg" style="max-width:100%;margin:0 auto;"/></div> 
        <div style="padding:20px;box-sizing:border-box;">
            <p><span style="font-size: 14pt;">Which iconic&nbsp;Avon Park spot best matches <em data-start="538" data-end="544">your personality?</em></span></p>
        </div>
        
        <form action="?p=quiz&v=4_Which-Famous-Avon-Park-Landmark-Are-You" method="post" name="quizform">
        ...
        <div style="padding:25px 0 30px 15px;border-top:solid #cccccc 1px;font-size:16pt;font-weight:bold;">
         ...
         <div id="quizquestion24" style="padding:10px 0;">
          What's your ideal afternoon?
         </div>
         
         <div class="quizquestioncontainer">
          
          <div id="quizquestionanswerdiv62" class="quizquestionmultiselect ">
           
           <input type="radio" id="questionanswer62" name="questionanswer_1" value="4_62" onclick="scrolltonextquestion('quest2');" required> <label for="questionanswer62" class="quizanswertext">Enjoying an elegant lunch</label>
           
          </div>
          
          <div id="quizquestionanswerdiv63" class="quizquestionmultiselect ">
           
           <input type="radio" id="questionanswer63" name="questionanswer_1" value="3_63" onclick="scrolltonextquestion('quest2');" required> <label for="questionanswer63" class="quizanswertext">A lively event with music, people, and photos</label>
           
          </div>
          
          <div id="quizquestionanswerdiv64" class="quizquestionmultiselect ">
           
           <input type="radio" id="questionanswer64" name="questionanswer_1" value="2_64" onclick="scrolltonextquestion('quest2');" required> <label for="questionanswer64" class="quizanswertext">A quiet moment by calm water at sunset</label>
           
          </div>
          
          <div id="quizquestionanswerdiv65" class="quizquestionmultiselect ">
           
           <input type="radio" id="questionanswer65" name="questionanswer_1" value="1_65" onclick="scrolltonextquestion('quest2');" required> <label for="questionanswer65" class="quizanswertext">Exploring old artifacts and hidden stories</label>
        ...
        <div style="padding:25px 0 30px 15px;border-top:solid #cccccc 1px;font-size:16pt;font-weight:bold;">
         ...
         <div id="quizquestion25" style="padding:10px 0;">
          How would your friends describe you?
         </div>
         
         <div class="quizquestioncontainer">
          
          <div id="quizquestionanswerdiv66" class="quizquestionmultiselect ">
           
           <input type="radio" id="questionanswer66" name="questionanswer_2" value="1_66" onclick="scrolltonextquestion('quest3');" required> <label for="questionanswer66" class="quizanswertext">Thoughtful, curious, and nostalgic</label>
           
          </div>
          
          <div id="quizquestionanswerdiv67" class="quizquestionmultiselect ">
           
           <input type="radio" id="questionanswer67" name="questionanswer_2" value="2_67" onclick="scrolltonextquestion('quest3');" required> <label for="questionanswer67" class="quizanswertext">Calm, steady, and easy to be around</label>
           
          </div>
          
          <div id="quizquestionanswerdiv68" class="quizquestionmultiselect ">
           
           <input type="radio" id="questionanswer68" name="questionanswer_2" value="3_68" onclick="scrolltonextquestion('quest3');" required> <label for="questionanswer68" class="quizanswertext">Friendly and always involved in the community</label>
           
          </div>
          
          <div id="quizquestionanswerdiv69" class="quizquestionmultiselect ">
           
           <input type="radio" id="questionanswer69" name="questionanswer_2" value="4_69" onclick="scrolltonextquestion('quest3');" required> <label for="questionanswer69" class="quizanswertext">Classic, warm, and charming</label>
        ...
        <div style="padding:25px 0 30px 15px;border-top:solid #cccccc 1px;font-size:16pt;font-weight:bold;">
         ...
         <div id="quizquestion26" style="padding:10px 0;">
          Where are you most likely to spend time?
         </div>
         
         <div class="quizquestioncontainer">
          
          <div id="quizquestionanswerdiv70" class="quizquestionmultiselect ">
           
           <input type="radio" id="questionanswer70" name="questionanswer_3" value="4_70" onclick="scrolltonextquestion('quest4');" required> <label for="questionanswer70" class="quizanswertext">Somewhere with charm, comfort, and a vintage feel</label>
           
          </div>
          
          <div id="quizquestionanswerdiv71" class="quizquestionmultiselect ">
           
           <input type="radio" id="questionanswer71" name="questionanswer_3" value="2_71" onclick="scrolltonextquestion('quest4');" required> <label for="questionanswer71" class="quizanswertext">Anywhere with water, sunshine, and a good view</label>
           
          </div>
          
          <div id="quizquestionanswerdiv72" class="quizquestionmultiselect ">
           
           <input type="radio" id="questionanswer72" name="questionanswer_3" value="1_72" onclick="scrolltonextquestion('quest4');" required> <label for="questionanswer72" class="quizanswertext">Somewhere peaceful and nostalgic</label>
           
          </div>
          
          <div id="quizquestionanswerdiv73" class="quizquestionmultiselect ">
           
           <input type="radio" id="questionanswer73" name="questionanswer_3" value="3_73" onclick="scrolltonextquestion('quest4');" required> <label for="questionanswer73" class="quizanswertext">At community gatherings or local festivities</label>
        ...
        <div style="padding:25px 0 30px 15px;border-top:solid #cccccc 1px;font-size:16pt;font-weight:bold;">
         ...
         <div id="quizquestion27" style="padding:10px 0;">
          Which atmosphere feels most like your ideal spot?
         </div>
         
         <div class="quizquestioncontainer">
          
          <div id="quizquestionanswerdiv74" class="quizquestionmultiselect ">
           
           <input type="radio" id="questionanswer74" name="questionanswer_4" value="2_74" onclick="scrolltonextquestion('quest5');" required> <label for="questionanswer74" class="quizanswertext">Calm, bright, and naturally beautiful</label>
           
          </div>
          
          <div id="quizquestionanswerdiv75" class="quizquestionmultiselect ">
           
           <input type="radio" id="questionanswer75" name="questionanswer_4" value="4_75" onclick="scrolltonextquestion('quest5');" required> <label for="questionanswer75" class="quizanswertext">Stylish, timeless, and a little luxurious</label>
           
          </div>
          
          <div id="quizquestionanswerdiv76" class="quizquestionmultiselect ">
           
           <input type="radio" id="questionanswer76" name="questionanswer_4" value="3_76" onclick="scrolltonextquestion('quest5');" required> <label for="questionanswer76" class="quizanswertext">Lively, social, and full of energy</label>
           
          </div>
          
          <div id="quizquestionanswerdiv77" class="quizquestionmultiselect ">
           
           <input type="radio" id="questionanswer77" name="questionanswer_4" value="1_77" onclick="scrolltonextquestion('quest5');" required> <label for="questionanswer77" class="quizanswertext">Cozy, quiet, and full of interesting stories</label>
        ...
        <div style="padding:25px 0 30px 15px;border-top:solid #cccccc 1px;font-size:16pt;font-weight:bold;">
         ...
         <div id="quizquestion28" style="padding:10px 0;">
          Which saying best fits your vibe?
         </div>
         
         <div class="quizquestioncontainer">
          
          <div id="quizquestionanswerdiv78" class="quizquestionmultiselect ">
           
           <input type="radio" id="questionanswer78" name="questionanswer_5" value="1_78" onclick="scrolltonextquestion('submitform');" required> <label for="questionanswer78" class="quizanswertext">“History gives life meaning.”</label>
           
          </div>
          
          <div id="quizquestionanswerdiv79" class="quizquestionmultiselect ">
           
           <input type="radio" id="questionanswer79" name="questionanswer_5" value="2_79" onclick="scrolltonextquestion('submitform');" required> <label for="questionanswer79" class="quizanswertext">“Calm waters, clear mind.”</label>
           
          </div>
          
          <div id="quizquestionanswerdiv80" class="quizquestionmultiselect ">
           
           <input type="radio" id="questionanswer80" name="questionanswer_5" value="4_80" onclick="scrolltonextquestion('submitform');" required> <label for="questionanswer80" class="quizanswertext">“Charm never goes out of style.”</label>
           
          </div>
          
          <div id="quizquestionanswerdiv81" class="quizquestionmultiselect ">
           
           <input type="radio" id="questionanswer81" name="questionanswer_5" value="3_81" onclick="scrolltonextquestion('submitform');" required> <label for="questionanswer81" class="quizanswertext">“People bring me energy.”</label>
                   ...
                   <div style="margin-left: auto;">
                    ...
                    <div style="position:relative;">
                     <div style="display:inline-block;position:absolute;right:0;top:10px;">
                       ...
                       <div style="display:inline-block;"><a href="https://twitter.com/share?text=Check%20Out%3A%20Avonparkhistoricalsociety%2Ecom%20Avon%20Park%20Historical%20Society&url=https%3A%2F%2Favonparkhistoricalsociety%2Ecom%2Findex%2Ecfm%3Fp%3Dquiz%26v%3D4%5FWhich%2DFamous%2DAvon%2DPark%2DLandmark%2DAre%2DYou" target="_blank"><img src="images/socialsites/twitter.png" width="24" height="24" alt="Tweet on Twitter" border="0"></a></div>
                       ...
                       <div class="fb-like" data-href="https://avonparkhistoricalsociety.com/index.cfm?p=quiz&v=4_Which-Famous-Avon-Park-Landmark-Are-You" data-width="" data-layout="button" data-action="like" data-size="small" data-share="true"></div>
                       </div>
                      </div>
                     </div>
                   </div>
