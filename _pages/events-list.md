...
<head>
     ...
     <title>
      Eventslist - Avonparkhistoricalsociety.com
     </title>
     ...
     <meta property="og:title" content="Eventslist - Avon Park Historical Society" />
...
#loginformcancel {
background:#444444;
/\_box-sizing: border-box;border: solid black 1px;border-radius: 5px;font-size: 12pt;height: 20px;padding: 5px 20px 25px 20px;background:#489900;color:white;font-weight: bold;cursor:pointer;*/
}
...
<body>
   ...
   <div id="loginboxcontainer">
             <div class="loginwrap">
                ...
                <form action="?p=eventslist" method="Post" name="loginform" class="loginform" id="loginform">
...
<div style="margin-bottom:10px;">
 <ul class="breadcrumb">
  ...
  <li class="active"><i class="fas fa-calendar-alt"></i> Event List</li>
 </ul>
</div>
<div class="grid">
    ...
    <div class="collisting no-padding">
        <div class="search">
            <form class="flow" action="?p=eventslist" method="post">
                <div class="fill">
                    
                        <input type="text" name="searchtext" placeholder="Search Community Events..." />
                ...
                <div>
                    <select name="category">
                        <option value="all">All Listings</option>
                            ...
                            <option value="7" >Club Meeting</option>
                        
                            <option value="8" >Kid Friendly</option>
        ...
        <div class="collisting" style="font-weight:bold;">
         Total Events: 0
        </div>
        <div class="collisting">
            <div>
                    ...
                    <div class="list-item">
                        <div style="box-sizing:border-box;padding:50px 10px;text-align:center;font-size:20pt;font-weight:bold;">
                            No Events Found 
                        </div>
                    </div>
...
.rssdesc {
 display:none;
        ...
        <a href="https://www.sebring.com/store#!/sebring+podcast+circle-A5c622fae2051766916c2e8a3?productType=111&sellable=dYXlwr75r7UZdzXO8eVO-111-22&appearance=67&src=productFeed&affiliateid=12277" target="_blank" alt="Store: Sebring Podcast Circle - Men's Hoodie denim blue https://www.sebring.com/store#!/sebring+podcast+circle-A5c622fae2051766916c2e8a3?productType=111&sellable=dYXlwr75r7UZdzXO8eVO-111-22&appearance=67&src=productFeed&affiliateid=12277" style="text-decoration:none;font-weight:bold;font-size:12pt;"><img src="https://image.spreadshirtmedia.com/image-server/v1/products/T111A67PA4247PT17X66Y0D1021036140W21807H22137Cx000000/views/1,width=1000,height=1000,appearanceId=67,backgroundColor=eeeeee/sebring-podcast-circle-mens-hoodie.jpg" style="display:block;max-width:98%;margin:0 auto;"></a>
         <div style="padding:5px;">
         <a href="https://www.sebring.com/store#!/sebring+podcast+circle-A5c622fae2051766916c2e8a3?productType=111&sellable=dYXlwr75r7UZdzXO8eVO-111-22&appearance=67&src=productFeed&affiliateid=12277" target="_blank" style="font-weight:bold;font-size:11pt;">Sebring Podcast Circle - Men's Hoodie denim blue</a>
         <p style="margin:10px 0px;padding:2px;font-size:11pt;">$41.49 USD <span style="float:right;"><a href="https://www.sebring.com/store#!/sebring+podcast+circle-A5c622fae2051766916c2e8a3?productType=111&sellable=dYXlwr75r7UZdzXO8eVO-111-22&appearance=67&src=productFeed&affiliateid=12277" target="_blank" style="text-decoration:none;font-weight:bold;font-size:12pt;">Buy Now</a></span></p> <p class="rssdesc" style="margin:1px;padding:1px;font-size:10pt;">Lightweight Hooded Sweatshirt for Men, 50% cotton, 50% polyester, Brand: Hanes</p>
                   ...
                   <div style="margin-left: auto;">
                    ...
                    <div style="position:relative;">
                     <div style="display:inline-block;position:absolute;right:0;top:10px;">
                       ...
                       <div style="display:inline-block;"><a href="https://twitter.com/share?text=Check%20Out%3A%20Avonparkhistoricalsociety%2Ecom%20Avon%20Park%20Historical%20Society&url=https%3A%2F%2Favonparkhistoricalsociety%2Ecom%2Findex%2Ecfm%3Fp%3Deventslist" target="_blank"><img src="images/socialsites/twitter.png" width="24" height="24" alt="Tweet on Twitter" border="0"></a></div>
                       ...
                       <div class="fb-like" data-href="https://avonparkhistoricalsociety.com/index.cfm?p=eventslist" data-width="" data-layout="button" data-action="like" data-size="small" data-share="true"></div>
                       </div>
                      </div>
                     </div>
                   </div>
